...
extension Defaults.Keys {
  ...
  static let playSoundOnCopy = Key<Bool>("playSoundOnCopy", default: true)
  static let showNotifications = Key<Bool>("showNotifications", default: true)
  static let popupAutomatically = Key<Bool>("popupAutomatically", default: true)
  ...
  static let windowSize = Key<NSSize>("windowSize", default: NSSize(width: 300, height: 800))
  ...
  static let maxDisplayLength = Key<Int>("maxDisplayLength", default: 100)
}
